...
const socialIcons = [
  ...
  {
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/ayush-kumar-ba712b3a5/",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    name: "GitHub",
    link: "https://github.com/ayushkumarsingh119147-sudo",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    name: "LeetCode",
    link: "https://leetcode.com/u/7bFytlPAvK/",
    icon: (
      // LeetCode SVG icon
...
const contactDetails = [
  ...
  },
  {
    ...
    content: (
      <a href="mailto:ayushkumarsingh119147@gmail.com" className="hover:underline">
  ...
  },
  {
    ...
    content: (
      <a href="tel:+917870723322" className="hover:underline">
        +91 7870723322
      </a>
    ),
  },
