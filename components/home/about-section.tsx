        ...
        >
            ...
            <div className="space-y-6 text-center lg:text-left">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 text-lg">
                    I am Ayush  Kumar, a dedicated Software Developer helping businesses and individuals transform digital ideas into engaging products using modern web tools.
                </p>
                <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 text-lg">
